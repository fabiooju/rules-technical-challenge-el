...
==== Start
image::images/scenarios_robot_placement/free_kick1_start.svg[Interactive,700,opts=interactive]
==== Goal
image::images/scenarios_robot_placement/free_kick1_goal.svg[Interactive,700,opts=interactive]

=== Scenario 2: Free Kick 2
==== Start
image::images/scenarios_robot_placement/free_kick2_start.svg[Interactive,700,opts=interactive]
==== Goal
image::images/scenarios_robot_placement/free_kick2_goal.svg[Interactive,700,opts=interactive]

=== Scenario 3: Kick Off
==== Start
image::images/scenarios_robot_placement/kick_off_start.svg[Interactive,700,opts=interactive]
==== Goal
image::images/scenarios_robot_placement/kick_off_goal.svg[Interactive,700,opts=interactive]

=== Scenario 4: Penalty
==== Start
image::images/scenarios_robot_placement/penalty_start.svg[Interactive,700,opts=interactive]
==== Goal
image::images/scenarios_robot_placement/penalty_goal.svg[Interactive,700,opts=interactive]
